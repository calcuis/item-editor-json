...
def process_request(command_type,guid_value,title,a,b,c,d,ans):
    ...
    if command_type == "_UPDATE_":
        ...
        if row >= 0:
            dict = {"id":guid_value, "title":title, 
...
trv.heading(3,text="a", anchor="center")
trv.heading(4,text="b", anchor="center")
trv.heading(5,text="c", anchor="center")
trv.heading(6,text="d", anchor="center")
trv.heading(7,text="ans", anchor="center")
