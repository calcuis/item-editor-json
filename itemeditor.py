...
input_frame = LabelFrame(root,text='Record',bg="lightgray",font=14)
input_frame.grid(row=0,column=0,rowspan=7,columnspan=4)

l1 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text="id",font=12).grid(row=1,column=0)
l2 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field01,font=12).grid(row=2,column=0)
l3 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field02,font=12).grid(row=3,column=0) 
l4 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field03,font=12).grid(row=4, column=0)
l5 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field04,font=12).grid(row=5,column=0)
l6 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field05,font=12).grid(row=6,column=0)
l7 = Label(input_frame,anchor="w",width=24,height=1,relief="ridge",text=field06,font=12).grid(row=7, column=0)
